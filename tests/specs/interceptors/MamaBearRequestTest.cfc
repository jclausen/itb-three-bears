...
*/
component extends="coldbox.system.testing.BaseInterceptorTest" interceptor="modules_app.MamaBear.interceptors.MamaBearRequest"{
	...
	function run(){
		...
		describe( "modules_app.MamaBear.interceptors.MamaBearRequest", function(){

...
*/
component extends="coldbox.system.testing.BaseInterceptorTest" interceptor="modules_app.BabyBear.interceptors.BabyBearRequest"{
	...
	function run(){
		...
		describe( "modules_app.BabyBear.interceptors.BabyBearRequest", function(){
